...
public class ClientFactory {
	...
	/*
	 * public static AmazonSQS createSQSClient() { ClientConfiguration clientConfig
	 * = createClientConfiguration();
	 * 
	 * return AmazonSQSClientBuilder .standard()
	 * .withClientConfiguration(clientConfig) .withCredentials(new
	 * ProfileCredentialsProvider()) .withRegion("eu-west-1") .build(); }
	 */
